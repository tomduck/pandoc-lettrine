"""setup.py - install script for the pandoc-lettrine filter."""

# Copyright 2018 Thomas J. Duck.
# All rights reserved.
#
...
setup(
    ...
    license='GPL',
    keywords='pandoc lettrine drop caps filter',
    url='https://github.com/tomduck/pandoc-lettrine',
    download_url='https://github.com/tomduck/pandoc-lettrine/tarball/'+VERSION,

    install_requires=['pandocfilters>=1.4.2,<2'],

    py_modules=['lettrine'],
    entry_points={'console_scripts':['lettrine = lettrine:main']},
    cmdclass=cmdclass,
